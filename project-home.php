    <div class="container-fluid">
    	...
    	<div class="row">
        	<div class="col-sm-12">
            	<div class="col-xs-12 col-sm-4 project-box" style="background-image:url('img/ip.png');">
                	<div class="labels">
...
<g>
                    	...
                    	<p class="green">Ip Gruppo API</p>
                    	<h1>TITLE</h1>  
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 project-box" style="background-image:url('img/bmw.png');">
                	<div class="labels">
                    <div class="triangle-up"></div>
                    <svg class="power" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="377.043px" height="377.043px" viewBox="0 0 377.043 377.043" style="enable-background:new 0 0 377.043 377.043;"
...
<g>
                    	...
                    	<p class="green">BMW Group</p>
                    	<h1>TITLE</h1>  
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 project-box" style="background-image:url('img/peppapig.png');">
                	<div class="labels">
                    <div class="triangle-up"></div>
                    <svg class="power" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="377.043px" height="377.043px" viewBox="0 0 377.043 377.043" style="enable-background:new 0 0 377.043 377.043;"
...
<g>
                    	...
                    	<p class="green">Giochi Preziosi</p>
                    	<h1>TITLE</h1>  
                    </div>
                </div>
            </div>
